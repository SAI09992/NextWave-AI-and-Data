    ...
    <section className="py-24 sm:py-32 relative border-t border-gray-800/60 bg-transparent overflow-hidden flex items-center justify-center min-h-[60vh]">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <motion.div
          ...
          className="max-w-4xl mx-auto rounded-3xl bg-gray-900/60 backdrop-blur-xl border border-cyan-500/30 p-10 sm:p-16 text-center space-y-8 shadow-[0_0_50px_rgba(0,229,255,0.1)] relative overflow-hidden"
        >
          {/* Inner ambient glow */}
          ...
          <div className="relative z-10 space-y-4">
            <h2 className="text-4xl sm:text-6xl font-black font-sans text-white tracking-tight">
              READY TO BUILD THE <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500">FUTURE?</span>
            </h2>
          ...
          <div className="relative z-10 pt-4 flex flex-col sm:flex-row items-center justify-center gap-6">
            <Link href={session ? (isAdmin ? '/admin' : '/portal') : '/register'}>
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="group relative flex items-center justify-center gap-3 px-10 py-5 bg-cyan-600 text-white rounded-xl font-bold font-sans text-lg overflow-hidden shadow-[0_0_20px_rgba(0,229,255,0.3)] w-full sm:w-auto"
              >
                <span className="absolute inset-0 w-full h-full bg-gradient-to-r from-cyan-400 to-blue-500 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
