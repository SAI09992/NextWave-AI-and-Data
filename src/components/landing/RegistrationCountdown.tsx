      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto flex flex-col items-center text-center space-y-8">
          ...
          <h2 className="text-4xl sm:text-6xl font-black font-sans text-white tracking-tight">
            TICKING <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-emerald-400">CLOCK</span>
          </h2>
          ...
          <div className="flex flex-wrap justify-center gap-4 sm:gap-8 pt-4">
            {timeBlocks.map((block, idx) => (
              <div key={idx} className="flex flex-col items-center gap-3">
                ...
                <span className="text-xs sm:text-sm font-bold font-mono tracking-widest text-cyan-500">
                  {block.label}
                </span>
              </div>
            ))}
          ...
          <div className="pt-8">
            <Link href="/register">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="group relative flex items-center justify-center gap-3 px-8 py-4 bg-cyan-600 text-white rounded-xl font-bold font-sans text-lg overflow-hidden shadow-[0_0_30px_rgba(0,229,255,0.4)]"
              >
