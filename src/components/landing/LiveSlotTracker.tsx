  ...
  return (
    <section id="seats" className="py-16 sm:py-24 relative bg-gray-900/40 border-t border-gray-800/60">
      <div className="container mx-auto px-4 relative z-10">
        <div className="w-full max-w-3xl mx-auto bg-gray-900/60 backdrop-blur-md rounded-3xl p-6 sm:p-10 border border-cyan-500/30 shadow-[0_0_30px_rgba(0,229,255,0.1)]">
          {/* Header */}
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-6 border-b border-gray-800">
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="text-[10px] font-mono font-bold text-cyan-500 uppercase tracking-widest mb-1">
                  // 01. LIVE METRICS
                </div>
            ...
            <button
              ...
              className="flex items-center gap-2 text-xs font-mono text-cyan-400/80 hover:text-cyan-400 bg-gray-800 px-4 py-2 rounded-lg border border-gray-700 hover:border-cyan-500/50 transition-all"
            >
          ...
          <div className="mt-10 space-y-4">
            <div className="flex items-end justify-between font-mono">
              ...
              <div className="text-right">
                ...
                <span className="ml-3 text-sm font-bold text-emerald-400">({totalPercent}%)</span>
              </div>
            </div>
            ...
            <div className="h-4 w-full rounded-full bg-gray-950 border border-gray-800 overflow-hidden p-0.5 relative">
              <motion.div
                ...
                className="absolute left-0 top-0 bottom-0 rounded-full bg-gradient-to-r from-blue-500 via-cyan-400 to-emerald-400 shadow-[0_0_15px_rgba(0,229,255,0.5)]"
              />
            </div>
            ...
            <div className="flex justify-between text-xs font-mono text-gray-400 pt-2">
              ...
              <span className="text-cyan-400 font-bold">{remaining} seats remaining</span>
            </div>
          </div>
