      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-14 space-y-4">
          ...
          <h2 className="text-3xl sm:text-5xl font-black font-sans text-white">
            WHO CAN <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500">APPLY?</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="p-8 rounded-3xl bg-gray-900/50 backdrop-blur-md border border-gray-800 hover:border-cyan-500/30 transition-all shadow-xl flex flex-col h-full"
          >
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            className="p-8 rounded-3xl bg-gray-900/50 backdrop-blur-md border border-gray-800 hover:border-blue-500/30 transition-all shadow-xl flex flex-col h-full relative overflow-hidden"
          >
            {/* Background Glow */}
