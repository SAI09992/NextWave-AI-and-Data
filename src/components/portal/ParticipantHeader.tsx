    ...
    <div className="p-6 rounded-2xl bg-gray-900/60 backdrop-blur-md border border-gray-800 shadow-xl space-y-6">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 pb-6 border-b border-gray-800">
        <div className="flex items-center gap-4">
          <div className="w-14 h-14 rounded-2xl bg-cyan-950/40 border-2 border-cyan-500/50 flex items-center justify-center text-cyan-400 text-xl font-bold font-sans shadow-[0_0_15px_rgba(0,229,255,0.2)]">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="px-2 py-0.5 rounded bg-cyan-950/60 text-cyan-400 border border-cyan-500/30 font-mono text-[10px] font-bold tracking-widest">
                PARTICIPANT
              </span>
            </div>
            <div className="flex flex-wrap items-center gap-2 text-xs font-mono text-gray-500 mt-1">
              ...
              <span className="text-cyan-500 font-bold">{registration.registrationId}</span>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 self-stretch sm:self-auto">
          <Link href="/portal/updates" className="flex-1 sm:flex-initial">
            <button className="w-full flex items-center justify-center gap-2 px-4 py-2 rounded-lg bg-gray-950 border border-gray-800 hover:border-cyan-500/50 text-gray-400 hover:text-cyan-400 transition-colors text-xs font-bold font-mono">
              <Bell className="w-4 h-4" />
              <span>UPDATES</span>
            </button>
          </Link>
          <Link href="/portal/schedule" className="flex-1 sm:flex-initial">
            <button className="w-full flex items-center justify-center gap-2 px-4 py-2 rounded-lg bg-gray-950 border border-gray-800 hover:border-blue-500/50 text-gray-400 hover:text-blue-400 transition-colors text-xs font-bold font-mono">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-5 gap-4 font-mono text-xs">
        ...
        <div className="p-3 rounded-xl bg-gray-950/50 border border-gray-800">
          ...
          <span className="text-emerald-400 font-bold mt-1 block truncate">
