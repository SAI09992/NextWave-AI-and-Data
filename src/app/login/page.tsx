      ...
      <div className="flex-1 flex items-center justify-center p-4">
        <CodeRevealWrapper>
          ...
          <div>
            ...
            <p className="text-xs font-mono text-nexus-text-muted mt-1">
              {session.user.email}
            </p>
          </div>
          ...
          <div className="pt-4 space-y-3">
            ...
            <Link href="/register" className="block">
              <NexusButton variant="secondary" size="md" className="w-full">
  ...
  return (
    <div className="flex-1 flex items-center justify-center p-4 min-h-[calc(100vh-4rem)] font-mono">
      <CodeRevealWrapper>
        ...
        {/* Security Notices */}
        <div className="p-3.5 rounded-xl bg-nexus-bg border border-nexus-border/80 text-[11px] text-nexus-text-dim text-center leading-relaxed space-y-2">
          <div className="text-nexus-text font-bold flex items-center justify-center gap-1.5">
...
export default function LoginPage() {
  return (
    <Suspense
      fallback={
        <div className="flex-1 flex items-center justify-center p-4">
          <div className="font-mono text-nexus-primary text-xs">LOADING LOGIN GATEWAY...</div>
        </div>
      }
    >
      <LoginContent />
