        ...
        <AnimatePresence mode="wait">
          {scannerActive ? (
            ...
            <motion.div
              ...
              exit={{ opacity: 0, y: -15 }}
              className="nexus-glass-glow rounded-2xl p-5 sm:p-8 border border-nexus-border shadow-nexus-card space-y-6 font-mono"
            >
              {/* Header */}
              <div className="flex items-center justify-between pb-4 border-b border-nexus-border">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="text-lg sm:text-xl font-bold text-nexus-text">
                      PAYMENT SUBMISSION
                    </h2>
                ...
                <div className="text-right">
                  <span className="text-[10px] text-nexus-text-dim block">FEE DUE</span>
                  <span className="text-2xl font-extrabold text-nexus-primary font-mono-numbers">
                    ₹{feeAmount}
                  </span>
                </div>
              </div>
              ...
              <div className="p-5 rounded-xl bg-nexus-surface/60 border border-nexus-border space-y-4">
                <div className="text-xs font-bold text-nexus-primary uppercase tracking-wider flex items-center gap-2">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-6 justify-center sm:justify-start">
                  {/* QR Code Container */}
                  <div className="p-3 rounded-xl bg-white text-black shadow-nexus-glow-sm shrink-0">
                    {customQrUrl ? (
                  ...
                  <div className="space-y-3 text-xs flex-1">
                    <div>
                      <span className="text-nexus-text-dim block text-[11px]">OFFICIAL UPI ID:</span>
                      <div className="flex items-center gap-2 mt-1">
                        <code className="px-3 py-1.5 rounded-lg bg-nexus-bg border border-nexus-border text-nexus-primary font-bold text-sm">
                          {upiId}
                        </code>
                        <button
                          type="button"
                    ...
                    <div className="space-y-1 text-nexus-text-muted text-[11px] leading-relaxed">
              ...
              <form onSubmit={handlePaymentSubmit} className="space-y-5 text-xs">
                ...
                <div className="space-y-1.5">
                  <label className="text-nexus-text flex items-center justify-between">
                    <span className="font-bold">Registration Reference ID (Locked)</span>
                    <span className="text-[10px] text-nexus-text-dim">Auto-assigned</span>
                  </label>
                  <input
                    type="text"
                    ...
                    readOnly
                    disabled
                    className="w-full px-3.5 py-2.5 rounded-lg bg-nexus-bg-elevated border border-nexus-border text-nexus-primary text-sm font-bold uppercase cursor-not-allowed select-none"
                  />
                </div>

                {/* SECTION 2: UTR NUMBER INPUT */}
                <div className="space-y-1.5">
                  <label className="text-nexus-text flex items-center justify-between font-bold">
                    <span className="flex items-center gap-1.5">
                      <Hash className="w-4 h-4 text-nexus-primary" />
                  ...
                  <input
                    ...
                    maxLength={24}
                    className="w-full px-3.5 py-2.5 rounded-lg bg-nexus-surface border border-nexus-border text-nexus-text text-sm font-mono uppercase focus:outline-none focus:border-nexus-primary"
                  />
                ...
                <div className="space-y-2">
                  <label className="text-nexus-text font-bold flex items-center gap-1.5">
                    <FileCheck className="w-4 h-4 text-nexus-secondary" />
                  ...
                  >
                    {previewUrl ? (
                      <div className="space-y-3">
                        ...
                        <span className="text-[10px] text-nexus-text-dim underline block">
                          Click to change screenshot
                        </span>
                      </div>
                    ) : (
                      <div className="space-y-2">
                        <Upload className="w-8 h-8 text-nexus-primary mx-auto opacity-80" />
                        <div className="text-nexus-text font-bold text-xs">
                ...
                <div className="pt-4 border-t border-nexus-border flex items-center justify-between">
                  <Link href="/portal" className="text-xs text-nexus-text-muted hover:text-nexus-primary">
                    ← Back to Portal
                  </Link>
    ...
    <Suspense
      fallback={
        <div className="flex-1 flex items-center justify-center p-4 min-h-[60vh]">
          <div className="flex flex-col items-center gap-4 font-mono text-nexus-primary">
