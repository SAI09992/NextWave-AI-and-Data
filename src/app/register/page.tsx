...
import Step3Residence from '@/components/registration/Step3Residence';
...
function RegisterContent() {
  ...
  const handleNextStep = async () => {
    ...
    if (formStep === 1) fieldsToValidate = ['name', 'email', 'phone', 'college'];
    else if (formStep === 2) fieldsToValidate = ['registerNumber', 'department', 'year', 'section', 'creditType'];
    else if (formStep === 3) fieldsToValidate = ['residenceType', 'hostelName', 'roomNumber'];
    ...
    return (
      <div className="flex-1 flex items-center justify-center p-4 min-h-[60vh]">
        <motion.div
          ...
          className="w-full max-w-md nexus-glass-glow rounded-2xl p-8 border border-nexus-border text-center space-y-6"
        >
          <div className="w-14 h-14 rounded-full bg-nexus-surface border border-nexus-primary/40 mx-auto flex items-center justify-center text-nexus-primary shadow-nexus-glow-sm">
          ...
          <div>
            ...
            <p className="text-xs font-mono text-nexus-text-muted mt-1.5 leading-relaxed">
              Sign in with Google to proceed with registration.
            </p>
          </div>

          <Link href="/login?callbackUrl=/register" className="block">
            <NexusButton variant="primary" glow size="lg" className="w-full gap-2">
      ...
      <div className="flex-1 flex items-center justify-center p-4 min-h-[60vh]">
        ...
        >
          ...
          <div>
            ...
            <div className="mt-4 p-3 rounded-lg bg-nexus-bg border border-nexus-border font-mono text-sm font-bold text-nexus-primary">
              ID: {successRegId}
            </div>
          </div>
      ...
      <div className="flex-1 flex items-center justify-center p-4 min-h-[60vh]">
        ...
        >
          ...
          <div>
            ...
            {!isUnpaid && (
              <div className="mt-3 p-3 rounded-lg bg-nexus-bg border border-nexus-border font-mono text-sm font-bold text-nexus-primary">
                {existingRegId}
              </div>
            )}
          </div>
          ...
          <div className="pt-2">
            {isUnpaid ? (
              ...
              <Link href="/portal" className="block">
                <NexusButton variant="primary" glow size="lg" className="w-full">
    ...
    return (
      <div className="flex-1 flex items-center justify-center p-4 min-h-[60vh]">
        <motion.div
          initial={{ opacity: 0, scale: 0.95 }}
          animate={{ opacity: 1, scale: 1 }}
          className="w-full max-w-md nexus-glass-glow rounded-2xl p-8 border border-rose-500/40 text-center space-y-6"
        >
          ...
          <div className="pt-2">
            <Link href="/" className="block">
              <NexusButton variant="secondary" size="lg" className="w-full">
                RETURN HOME
              </NexusButton>
            </Link>
          </div>
  ...
  const stepLabels = ['PERSONAL', 'ACADEMIC', 'RESIDENCE', 'REVIEW'];
        ...
        {flowStage === 'form' && (
          ...
          >
            ...
            <div className="space-y-3">
              ...
              <div className="h-2 w-full rounded-full bg-nexus-bg border border-nexus-border overflow-hidden">
                <motion.div
                  initial={false}
