...
export default function AdminSettingsPage() {
  ...
  return (
    <div className="space-y-6 font-mono text-xs max-w-4xl mx-auto pb-12">
      {/* Header */}
      <div className="flex items-center justify-between pb-6 border-b border-nexus-border">
        <div>
      ...
      <div className="p-6 rounded-2xl nexus-glass-glow border-2 border-purple-500/50 space-y-5">
        <div className="flex items-center justify-between">
          ...
          <span className="text-[11px] text-nexus-text-dim">
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            className="flex-1 px-3.5 py-2.5 rounded-lg bg-nexus-surface border border-nexus-border text-nexus-text text-sm focus:outline-none focus:border-purple-500"
        ...
        <div className="space-y-2 max-h-48 overflow-y-auto">
          {coordinators.length === 0 ? (
            <div className="text-center py-4 text-nexus-text-dim text-xs">
            ...
            coordinators.map((coord) => (
              <div
                key={coord.id}
                className="flex items-center justify-between px-4 py-3 rounded-lg bg-nexus-surface/60 border border-nexus-border/60 group hover:border-purple-500/40 transition-colors"
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-bold text-nexus-text text-xs">{coord.name || 'Admin'}</div>
                    <div className="text-[10px] text-nexus-text-dim">{coord.email}</div>
                  </div>
                </div>
                <button
                  type="button"
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <div className="space-y-1">
                  <label className="text-nexus-text-dim block text-[11px] font-bold">FULL NAME</label>
                  <input
                    type="text"
                    value={coord.name}
                ...
                <div className="space-y-1">
                  <label className="text-nexus-text-dim block text-[11px] font-bold">ROLE / DESIGNATION</label>
                  <input
                    type="text"
                    value={coord.role}
                ...
                <div className="space-y-1">
                  <label className="text-nexus-text-dim block text-[11px] font-bold">DEPT / YEAR</label>
                  <input
                    type="text"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div className="space-y-1">
                  <label className="text-nexus-text-dim block text-[11px] font-bold flex items-center gap-1.5">
                    <Phone className="w-3 h-3 text-nexus-primary" />
      ...
      <form onSubmit={handleSave} className="space-y-6">
        ...
        <div className="p-6 rounded-2xl nexus-glass border border-nexus-border space-y-5">
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs text-nexus-text-dim">
              CURRENT SLOTS: <strong className="text-nexus-primary text-sm">{settings.totalCapacity}</strong>
            </span>
          </div>

          <div className="p-4 rounded-xl bg-nexus-bg/80 border border-nexus-border/80 space-y-4">
            <label className="text-nexus-text block font-bold text-xs">
              MANAGE TOTAL BOOTCAMP SLOTS
            </label>

            <div className="flex flex-wrap items-center gap-2">
              <span className="text-[11px] text-nexus-text-dim mr-1">QUICK ADJUST:</span>
              {[-50, -10, -1].map((v) => (
                <button
                  key={v}
                  type="button"
              ...
              <div className="h-6 w-px bg-nexus-border mx-1" />
              {[1, 10, 50].map((v) => (
                <button
                  key={v}
                  type="button"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
              <div className="space-y-1">
                <label className="text-nexus-text block font-bold text-[11px]">Exact Total Capacity (Seats)</label>
                <input
                  type="number"
                  min={1}
                  ...
                  className="w-full px-3.5 py-2.5 rounded-lg bg-nexus-surface border border-nexus-border text-nexus-text text-sm font-bold focus:outline-none focus:border-nexus-primary"
                />
              </div>

              <div className="space-y-1">
                <label className="text-nexus-text block font-bold text-[11px]">Registration Fee (₹)</label>
                <input
                  type="number"
                  min={0}
          ...
          <div className="p-4 rounded-xl bg-amber-950/30 border border-amber-500/40 space-y-4 mt-4">
            ...
            <div className="flex flex-wrap items-center gap-2">
              <span className="text-[11px] text-nexus-text-dim mr-1 font-bold">QUICK ADJUST BOOST:</span>
              {[-50, -10, -5].map((v) => (
                <button
                  key={`boost${v}`}
                  type="button"
            ...
            <div className="space-y-1">
              <label className="text-nexus-text block font-bold text-[11px]">Exact Boost Offset (Set 0 to show real count only)</label>
              <input
                type="number"
                min={0}
                ...
                className="w-full sm:w-48 px-3.5 py-2.5 rounded-lg bg-nexus-surface border border-amber-500/40 text-nexus-text text-sm font-bold focus:outline-none focus:border-amber-400"
              />
            </div>
          </div>
        </div>
        ...
        <div className="p-6 rounded-2xl nexus-glass border border-nexus-border space-y-4">
          <div className="text-sm font-bold text-nexus-secondary uppercase tracking-wider flex items-center gap-2">
          ...
          <div className="space-y-4">
            <div className="space-y-1">
              <label className="text-nexus-text block font-bold">Official UPI ID</label>
              <input
                type="text"
        ...
        <div className="p-6 rounded-2xl nexus-glass border border-orange-500/40 space-y-4">
          ...
          <div className="space-y-4">
            <div className="space-y-1">
              <label className="text-nexus-text block font-bold text-xs">WhatsApp Group Invite Link</label>
              <input
                type="text"
        ...
        <div className="p-6 rounded-2xl nexus-glass border border-nexus-border space-y-4">
          ...
          <div className="space-y-1">
            <label className="text-nexus-text block font-bold">Target ISO Date & Time</label>
            <input
              type="text"
        ...
        <div className="p-6 rounded-2xl nexus-glass border border-nexus-border space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="space-y-1">
              <label className="text-nexus-text block font-bold">Bootcamp Dates</label>
              <input
                type="text"
            ...
            <div className="space-y-1">
              <label className="text-nexus-text block font-bold">Venue / Room</label>
              <input
                type="text"
            ...
            <div className="space-y-1">
              <label className="text-nexus-text block font-bold">Support Email</label>
              <input
                type="email"
            ...
            <div className="space-y-1">
              <label className="text-nexus-text block font-bold">Support Phone</label>
              <input
                type="text"
