  ...
  return (
    <div className="space-y-6 font-mono text-xs max-w-6xl mx-auto">
      ...
      <div className="flex items-center justify-between pb-6 border-b border-nexus-border">
        ...
        <button
          onClick={fetchData}
          className="p-2 rounded-lg bg-nexus-surface border border-nexus-border text-nexus-text-muted hover:text-nexus-primary"
      ...
      {loading ? (
        <div className="flex items-center justify-center py-20">
          ...
          <span className="ml-3 text-nexus-text-muted">LOADING LIVE ANALYTICS...</span>
        </div>
      ) : !hasData ? (
        <div className="text-center py-20 text-nexus-text-muted space-y-2">
          <Users className="w-10 h-10 mx-auto text-nexus-text-dim" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-5 p-6 rounded-2xl nexus-glass border border-nexus-border space-y-4">
            <div className="flex items-center justify-between border-b border-nexus-border pb-3">
              <h3 className="text-sm font-bold text-nexus-text flex items-center gap-2">
                <PieIcon className="w-4 h-4 text-nexus-primary" />
          ...
          <div className="lg:col-span-7 p-6 rounded-2xl nexus-glass border border-nexus-border space-y-4">
            ...
            <div className="h-64 w-full">
              {analytics.registrationVelocity.length > 0 ? (
                ...
                <div className="flex items-center justify-center h-full text-nexus-text-dim">
          ...
          <div className="lg:col-span-5 p-6 rounded-2xl nexus-glass border border-nexus-border space-y-4">
            ...
            {analytics.yearBreakdown.length > 0 && (
              <div className="space-y-1.5 pt-2 border-t border-nexus-border/40">
                <div className="text-[11px] text-nexus-text-dim font-bold uppercase">By Year</div>
                {analytics.yearBreakdown.map((y: any, i: number) => (
                  <div key={i} className="flex items-center justify-between text-xs px-2 py-1.5 rounded bg-nexus-surface/40">
                    <span className="text-nexus-text">{y.name}</span>
                    <span className="font-bold text-nexus-primary">{y.count}</span>
                  </div>
                ))}
              </div>
            )}
