    ...
    <div className="space-y-8 font-sans text-sm max-w-7xl mx-auto text-white">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-6 border-b border-gray-800">
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2 px-4 py-2 rounded-lg bg-gray-900 border border-gray-700 text-cyan-400 font-mono text-xs shadow-lg">
          ...
          <div className="p-6 rounded-2xl bg-gray-900/50 backdrop-blur-md border border-gray-800 space-y-6 shadow-xl">
            ...
            <div className="p-5 rounded-xl bg-gray-950 border border-gray-800 space-y-4 shadow-inner">
              <div className="flex items-center justify-between">
                <span className="font-bold font-mono text-xs flex items-center gap-2 text-white">
                  <Users className="w-4 h-4 text-cyan-400" /> LIVE BOOTCAMP CAPACITY CONTROL
                </span>
                <span className="text-[11px] text-gray-500 font-mono">
                  TOTAL: <strong className="text-cyan-400 text-sm font-bold">{stats.totalCapacity} SLOTS</strong>
                </span>
              </div>
              ...
              <div className="flex flex-wrap items-center justify-between gap-3 pt-2">
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="px-3 py-2 rounded-lg bg-emerald-950/40 border border-emerald-500/40 text-emerald-400 font-bold hover:bg-emerald-900/60 transition-colors text-xs font-mono"
                  >
                    +1 Slot
                  </button>
                  <button
                ...
                <Link
                  href="/admin/settings"
                  className="text-xs text-cyan-400 hover:text-cyan-300 font-bold font-mono transition-colors"
                >
                  Manage All Settings →
                </Link>
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <Link href="/admin/payments" className="block">
                <div className="p-5 rounded-xl bg-gray-950 hover:bg-gray-900 border border-cyan-500/30 hover:border-cyan-500/60 transition-all space-y-2 h-full shadow-lg">
              ...
              <Link href="/admin/attendance" className="block">
                <div className="p-5 rounded-xl bg-gray-950 hover:bg-gray-900 border border-emerald-500/30 hover:border-emerald-500/60 transition-all space-y-2 h-full shadow-lg">
              ...
              <Link href="/admin/registrations" className="block">
                <div className="p-5 rounded-xl bg-gray-950 hover:bg-gray-900 border border-blue-500/30 hover:border-blue-500/60 transition-all space-y-2 h-full shadow-lg">
          ...
          <div className="p-6 rounded-2xl bg-gray-900/50 backdrop-blur-md border border-gray-800 space-y-4 h-full flex flex-col justify-between shadow-xl">
            <div>
              <div className="flex items-center justify-between border-b border-gray-800 pb-4">
                ...
                <span className="text-[10px] text-emerald-400 font-bold">REALTIME FEED</span>
              </div>
